...
| ---------------------------- | ---- | ---- | ---- | ---- |
| `09-editing-latency.ipynb`   | 13   | 0    | 5    | 0    |
...
**What the ten SKIPs are, and they are the honest part of this run.** Every one
of them is a browser half, and every one of them skips for the same measured
reason: the transition removed the `agent` option from both sites'
