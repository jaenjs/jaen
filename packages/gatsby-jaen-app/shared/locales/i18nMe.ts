...
export function getI18nMe(code: I18nCode) {
  if (code === 'en-US') {
    return {
      ...
      strings: {
        ...
        LocationBody: 'While this is on, the office sees where you are during a ride. Only your latest position is kept, never a track, and nothing is sent between rides.',
        LocationSwitch: 'Share position',
        LocationUnsupported: 'This device cannot determine its position.',
        LocationDenied: 'The browser has blocked access to your position. Allow it in the site settings and try again.',
        LocationUnavailable: 'The device cannot find its position right now. Nothing is sent until it can.',
        LocationTimeout: 'The device is taking too long to find its position. Nothing is sent until it does.',
        LocationOff: 'Off. The office does not see where you are.',
        LocationNoRide: 'No ride at the moment. Sending starts with your next ride.',
        LocationCheckFailed: 'Could not ask whether you have a ride. Trying again shortly.',
        LocationRideHint: 'Sent at most every 15 seconds, when you have moved or a minute has passed.',
        ...
        PushDenied: 'Notifications are blocked in the browser. Allow them in the site settings and try again.',
  ...
  if (code === 'tr-TR') {
    return {
      ...
      strings: {
        ...
        LocationBody: 'Bu açıkken ofis bir yolculuk sırasında nerede olduğunu görür. Yalnızca son konumun saklanır, asla bir iz kaydı tutulmaz ve yolculuklar arasında hiçbir şey gönderilmez.',
        LocationSwitch: 'Konumu paylaş',
        LocationUnsupported: 'Bu cihaz konumunu belirleyemiyor.',
        LocationDenied: 'Tarayıcı konum erişimini engelledi. Site ayarlarından izin ver ve tekrar dene.',
        LocationUnavailable: 'Cihaz şu anda konumunu bulamıyor. Bulana kadar hiçbir şey gönderilmez.',
        LocationTimeout: 'Cihazın konumunu bulması çok uzun sürüyor. Bulana kadar hiçbir şey gönderilmez.',
        LocationOff: 'Kapalı. Ofis nerede olduğunu görmüyor.',
        LocationNoRide: 'Şu anda yolculuk yok. Gönderim bir sonraki yolculuğunla başlar.',
        LocationCheckFailed: 'Yolculuğun olup olmadığı sorulamadı. Birazdan tekrar denenecek.',
        LocationRideHint: 'En fazla 15 saniyede bir, hareket ettiğinde ya da bir dakika geçtiğinde gönderilir.',
        ...
        PushDenied: 'Bildirimler tarayıcıda engellenmiş. Site ayarlarından izin ver ve tekrar dene.',
  ...
  if (code === 'ar-EG') {
    return {
      ...
      strings: {
        ...
        LocationBody: 'ما دام هذا مفعّلًا يرى المكتب أين أنت أثناء الرحلة. يُحفظ آخر موقع فقط، ولا يُسجَّل مسار أبدًا، ولا يُرسل شيء بين الرحلات.',
        LocationSwitch: 'مشاركة الموقع',
        LocationUnsupported: 'هذا الجهاز لا يستطيع تحديد موقعه.',
        LocationDenied: 'المتصفح يمنع الوصول إلى موقعك. اسمح به من إعدادات الموقع وحاول مرة أخرى.',
        LocationUnavailable: 'لا يستطيع الجهاز تحديد موقعه الآن. لن يُرسل شيء حتى يتمكن.',
        LocationTimeout: 'يستغرق الجهاز وقتًا طويلًا لتحديد موقعه. لن يُرسل شيء حتى ينجح.',
        LocationOff: 'متوقف. لا يرى المكتب أين أنت.',
        LocationNoRide: 'لا توجد رحلة حاليًا. يبدأ الإرسال مع رحلتك التالية.',
        LocationCheckFailed: 'تعذّر السؤال عمّا إذا كانت لديك رحلة. ستُعاد المحاولة قريبًا.',
        LocationRideHint: 'يُرسل كل 15 ثانية على الأكثر، عندما تتحرك أو تمرّ دقيقة.',
        ...
        PushDenied: 'الإشعارات محظورة في المتصفح. اسمح بها من إعدادات الموقع وحاول مرة أخرى.',
  ...
  return {
    ...
    strings: {
      ...
      ColorBody: 'Die Zentrale sieht deine Fahrten in dieser Farbe, und du auch.',
      ...
      LocationBody: 'Solange das eingeschaltet ist, sieht die Zentrale während einer Fahrt, wo du bist. Es wird nur dein letzter Standort gespeichert, nie eine Spur, und zwischen den Fahrten wird nichts gesendet.',
      LocationSwitch: 'Standort teilen',
      LocationUnsupported: 'Dieses Gerät kann seinen Standort nicht bestimmen.',
      LocationDenied: 'Der Browser blockiert den Zugriff auf deinen Standort. Erlaube ihn in den Website-Einstellungen und versuche es noch einmal.',
      LocationUnavailable: 'Das Gerät findet seinen Standort gerade nicht. Es wird nichts gesendet, bis es ihn hat.',
      LocationTimeout: 'Das Gerät braucht zu lange für den Standort. Es wird nichts gesendet, bis er da ist.',
      LocationOff: 'Aus. Die Zentrale sieht nicht, wo du bist.',
      LocationNoRide: 'Gerade keine Fahrt. Das Senden beginnt mit deiner nächsten Fahrt.',
      LocationCheckFailed: 'Ob du eine Fahrt hast, ließ sich nicht abfragen. Gleich noch ein Versuch.',
      LocationRideHint: 'Höchstens alle 15 Sekunden, wenn du dich bewegt hast oder eine Minute vergangen ist.',
      ...
      PushDenied: 'Benachrichtigungen sind im Browser blockiert. Erlaube sie in den Website-Einstellungen und versuche es noch einmal.',
